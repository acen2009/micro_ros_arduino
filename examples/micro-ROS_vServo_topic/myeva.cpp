...
MyVirtualCNC VirtualCNC5;
MyVirtualCNC VirtualCNC6;
...
MyVirtualServo VirtualServo9;
MyVirtualServo VirtualServo10;
MyVirtualServo VirtualServo11;
MyVirtualServo VirtualServo12;
MyVirtualEncoder VirtualEncoder1;
MyVirtualEncoder VirtualEncoder2;
MyVirtualEncoder VirtualEncoder3;
MyVirtualEncoder VirtualEncoder4;
MyVirtualEncoder VirtualEncoder5;
MyVirtualEncoder VirtualEncoder6;
MyVirtualEncoder VirtualEncoder7;
MyVirtualEncoder VirtualEncoder8;
MyVirtualEncoder VirtualEncoder9;
MyVirtualEncoder VirtualEncoder10;
MyVirtualEncoder VirtualEncoder11;
MyVirtualEncoder VirtualEncoder12;
void _task_handler();
...
int MyEVA::begin(void (*userCallback)(void), bool skipStart)
{
    ...
    _VA_CNC[0] = &VirtualCNC1;
    VirtualCNC1.init(MachineMapping[0].Object);
    _VA_CNC[1] = &VirtualCNC2;
    VirtualCNC2.init(MachineMapping[1].Object);
    _VA_CNC[2] = &VirtualCNC3;
    VirtualCNC3.init(MachineMapping[2].Object);
    _VA_CNC[3] = &VirtualCNC4;
    VirtualCNC4.init(MachineMapping[3].Object);
    _VA_CNC[4] = &VirtualCNC5;
    VirtualCNC5.init(MachineMapping[4].Object);
    _VA_CNC[5] = &VirtualCNC6;
    VirtualCNC6.init(MachineMapping[5].Object);
    _VA_CNC_SIZE = 6;
    _VA_ENC[0] = &VirtualEncoder1;
    VirtualEncoder1.init(EncoderMapping[0].Object, EncoderMapping[0].Port);
    _VA_ENC[1] = &VirtualEncoder2;
    VirtualEncoder2.init(EncoderMapping[1].Object, EncoderMapping[1].Port);
    _VA_ENC[2] = &VirtualEncoder3;
    VirtualEncoder3.init(EncoderMapping[2].Object, EncoderMapping[2].Port);
    _VA_ENC[3] = &VirtualEncoder4;
    VirtualEncoder4.init(EncoderMapping[3].Object, EncoderMapping[3].Port);
    _VA_ENC[4] = &VirtualEncoder5;
    VirtualEncoder5.init(EncoderMapping[4].Object, EncoderMapping[4].Port);
    _VA_ENC[5] = &VirtualEncoder6;
    VirtualEncoder6.init(EncoderMapping[5].Object, EncoderMapping[5].Port);
    _VA_ENC[6] = &VirtualEncoder7;
    VirtualEncoder7.init(EncoderMapping[6].Object, EncoderMapping[6].Port);
    _VA_ENC[7] = &VirtualEncoder8;
    VirtualEncoder8.init(EncoderMapping[7].Object, EncoderMapping[7].Port);
    _VA_ENC[8] = &VirtualEncoder9;
    VirtualEncoder9.init(EncoderMapping[8].Object, EncoderMapping[8].Port);
    _VA_ENC[9] = &VirtualEncoder10;
    VirtualEncoder10.init(EncoderMapping[9].Object, EncoderMapping[9].Port);
    _VA_ENC[10] = &VirtualEncoder11;
    VirtualEncoder11.init(EncoderMapping[10].Object, EncoderMapping[10].Port);
    _VA_ENC[11] = &VirtualEncoder12;
    VirtualEncoder12.init(EncoderMapping[11].Object, EncoderMapping[11].Port);
    _VA_ENC_SIZE = 12;
    if (mapping[0]) {
    ...
    CiA402Data* cia402;
    if (ServoMapping[0].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[0].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[0].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[0].Object))->cia402GetServo(ServoMapping[0].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[0].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[0].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[0].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[0].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[0].Port]);
            }
        }
        _VA_SERVO[0] = &VirtualServo1;
        VirtualServo1.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo1.attach((void*)cia402Obj);
        if (ServoMapping[0].subType == CIA402_TYPE)
            VirtualServo1.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[0].Port]);
    }
    if (ServoMapping[1].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[1].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[1].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[1].Object))->cia402GetServo(ServoMapping[1].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[1].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[1].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[1].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[1].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[1].Port]);
            }
        }
        _VA_SERVO[1] = &VirtualServo2;
        VirtualServo2.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo2.attach((void*)cia402Obj);
        if (ServoMapping[1].subType == CIA402_TYPE)
            VirtualServo2.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[1].Port]);
    }
    if (ServoMapping[2].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[2].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[2].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[2].Object))->cia402GetServo(ServoMapping[2].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[2].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[2].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[2].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[2].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[2].Port]);
            }
        }
        _VA_SERVO[2] = &VirtualServo3;
        VirtualServo3.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo3.attach((void*)cia402Obj);
        if (ServoMapping[2].subType == CIA402_TYPE)
            VirtualServo3.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[2].Port]);
    }
    if (ServoMapping[3].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[3].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[3].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[3].Object))->cia402GetServo(ServoMapping[3].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[3].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[3].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[3].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[3].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[3].Port]);
            }
        }
        _VA_SERVO[3] = &VirtualServo4;
        VirtualServo4.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo4.attach((void*)cia402Obj);
        if (ServoMapping[3].subType == CIA402_TYPE)
            VirtualServo4.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[3].Port]);
    }
    if (ServoMapping[4].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[4].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[4].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[4].Object))->cia402GetServo(ServoMapping[4].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[4].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[4].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[4].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[4].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[4].Port]);
            }
        }
        _VA_SERVO[4] = &VirtualServo5;
        VirtualServo5.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo5.attach((void*)cia402Obj);
        if (ServoMapping[4].subType == CIA402_TYPE)
            VirtualServo5.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[4].Port]);
    }
    if (ServoMapping[5].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[5].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[5].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[5].Object))->cia402GetServo(ServoMapping[5].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[5].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[5].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[5].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[5].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[5].Port]);
            }
        }
        _VA_SERVO[5] = &VirtualServo6;
        VirtualServo6.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo6.attach((void*)cia402Obj);
        if (ServoMapping[5].subType == CIA402_TYPE)
            VirtualServo6.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[5].Port]);
    }
    if (ServoMapping[6].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[6].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[6].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[6].Object))->cia402GetServo(ServoMapping[6].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[6].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[6].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[6].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[6].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[6].Port]);
            }
        }
        _VA_SERVO[6] = &VirtualServo7;
        VirtualServo7.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo7.attach((void*)cia402Obj);
        if (ServoMapping[6].subType == CIA402_TYPE)
            VirtualServo7.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[6].Port]);
    }
    if (ServoMapping[7].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[7].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[7].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[7].Object))->cia402GetServo(ServoMapping[7].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[7].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[7].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[7].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[7].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[7].Port]);
            }
        }
        _VA_SERVO[7] = &VirtualServo8;
        VirtualServo8.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo8.attach((void*)cia402Obj);
        if (ServoMapping[7].subType == CIA402_TYPE)
            VirtualServo8.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[7].Port]);
    }
    if (ServoMapping[8].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[8].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[8].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[8].Object))->cia402GetServo(ServoMapping[8].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[8].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[8].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[8].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[8].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[8].Port]);
            }
        }
        _VA_SERVO[8] = &VirtualServo9;
        VirtualServo9.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo9.attach((void*)cia402Obj);
        if (ServoMapping[8].subType == CIA402_TYPE)
            VirtualServo9.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[8].Port]);
    }
    if (ServoMapping[9].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[9].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[9].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[9].Object))->cia402GetServo(ServoMapping[9].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[9].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[9].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[9].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[9].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[9].Port]);
            }
        }
        _VA_SERVO[9] = &VirtualServo10;
        VirtualServo10.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo10.attach((void*)cia402Obj);
        if (ServoMapping[9].subType == CIA402_TYPE)
            VirtualServo10.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[9].Port]);
    }
    if (ServoMapping[10].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[10].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[10].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[10].Object))->cia402GetServo(ServoMapping[10].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[10].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[10].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[10].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[10].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[10].Port]);
            }
        }
        _VA_SERVO[10] = &VirtualServo11;
        VirtualServo11.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo11.attach((void*)cia402Obj);
        if (ServoMapping[10].subType == CIA402_TYPE)
            VirtualServo11.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[10].Port]);
    }
    if (ServoMapping[11].Object != NULL) {
        int n = findObjectOrderN(ServoMapping[11].Object, ObjectPointer);
        cia402 = (CiA402Data*)setting->Slave[n].PrivateData;
        EthercatDevice_CiA402* cia402Obj;
        if (cia402 != NULL) {
            if (ServoMapping[11].subType == _3AXIS_TYPE)
                cia402Obj = ((EthercatDevice_DmpStepper_Generic*)(ServoMapping[11].Object))->cia402GetServo(ServoMapping[11].Port + 1, NULL);
            else
                cia402Obj = (EthercatDevice_CiA402*)ServoMapping[11].Object;

            if (cia402Obj != NULL) {
                cia402Obj->setCiA402Mode(CIA402_HOMING_MODE); delay(100);
                cia402Obj->hm_SetHomingMethod(cia402->cia402_homingMode[ServoMapping[11].Port]);
                cia402Obj->hm_SetHomingSpeeds(cia402->cia402_homing_v[ServoMapping[11].Port], 20);
                cia402Obj->hm_SetHomingAcceleration(cia402->cia402_homing_acc[ServoMapping[11].Port]);
                cia402Obj->setCiA402Mode(CIA402_PP_MODE); delay(100);
                cia402Obj->driveSetMaxMotorSpeed(cia402->cia402_max_v[ServoMapping[11].Port]);
            }
        }
        _VA_SERVO[11] = &VirtualServo12;
        VirtualServo12.init(VIRTUALSERVO_ETHERCAT);
        VirtualServo12.attach((void*)cia402Obj);
        if (ServoMapping[11].subType == CIA402_TYPE)
            VirtualServo12.angleMap(0.0, 360.0, 0.0, cia402->cia402_PPR[ServoMapping[11].Port]);
    }
    _VA_SERVO_SIZE = 12;
